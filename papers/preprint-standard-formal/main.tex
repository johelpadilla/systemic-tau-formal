...
Preprint document version: \texttt{0.1.9-r2} (2026-07-24).\\
...
J.~Padilla-Villanueva.
\newblock A machine-checkable operational standard for Systemic Tau \(\taus\) and the Discrete Extramental Clock (RECD) (preprint 0.1.9-r2).
\newblock Zenodo, 2026.
