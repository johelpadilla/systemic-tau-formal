...
|-------|----------------------|-------------|
| **Operational standard preprint (EN)** | `preprint-standard-formal/` · doc **0.1.8-r2** · PDF `preprint-standard-formal/pins/standard-formal-v0.1.8-r2.pdf` · software DOI [10.5281/zenodo.21522882](https://doi.org/10.5281/zenodo.21522882) | full `SystemicTau/` |
