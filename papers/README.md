...
|-------|----------------------|-------------|
| **Operational standard preprint (EN)** | `preprint-standard-formal/` · doc **0.1.8-r3** · PDF pin + DOI **[10.5281/zenodo.21523232](https://doi.org/10.5281/zenodo.21523232)** · software [10.5281/zenodo.21522882](https://doi.org/10.5281/zenodo.21522882) | full `SystemicTau/` |
