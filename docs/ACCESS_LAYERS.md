...
| Artifact | Role |
|----------|------|
| PyPI `systemictau` | Production reference implementation |
| Zenodo DOI `10.5281/zenodo.20576241` | Corpus + software archive |
| `~/grok-work/tau-sistemic` | Applied dengue / RQA materials (sibling project) |
| `Fundacion_RECD` (local TeX) | Foundations manuscript source |
